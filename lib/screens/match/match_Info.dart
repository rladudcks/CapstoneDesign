...
import 'package:tennis_jamiss/screens/match/match_info_view_model.dart';
...
// 저장할 변수들
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
        create: (context) => MatchInfoViewModel(),
        builder: (context, _) {
          final matchInfoListFromViewModel =
              context.watch<MatchInfoViewModel>().matchInfoList;

          final getMethod =
              context.read<MatchInfoViewModel>().getMatchInfoList();

          return Scaffold(
            appBar: AppBar(
              title: Text(
                matchInfoListFromViewModel.first.description,
                style: TextStyle(
